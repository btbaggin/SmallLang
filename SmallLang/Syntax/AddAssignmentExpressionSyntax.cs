...
{
    public class AddAssignmentExpressionSyntax : ExpressionSyntax
    {
        ...
        public AddAssignmentExpressionSyntax(int pPrecedence, IdentifierSyntax pLeft, ExpressionSyntax pRight) : base(pPrecedence)
        {
            Name = pLeft;
            Value = pRight;
            Name.Parent = this;
