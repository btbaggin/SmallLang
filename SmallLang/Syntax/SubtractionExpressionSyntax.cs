...
{
    public class SubtractionExpressionSyntax : BinaryExpressionSyntax
    {
        ...
        public SubtractionExpressionSyntax(int pPrecedence, ExpressionSyntax pLeft, ExpressionSyntax pRight) : base(pPrecedence, pLeft, pRight) { }
