...
{
    public class MultiplicationExpressionSyntax : BinaryExpressionSyntax
    {
        ...
        public MultiplicationExpressionSyntax(int pPrecedence, ExpressionSyntax pLeft, ExpressionSyntax pRight) : base(pPrecedence, pLeft, pRight) { }
